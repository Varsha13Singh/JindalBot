...
# Streamlit UI Setup
# --------------------
st.set_page_config(page_title="JIMS Assistant", page_icon="🤖")
st.title("🩺 JIMS Assistant")
st.markdown("""
**Your Multilingual Medical Guide for JIMS Hospital**  
Ask me anything about JIMS hospital departments, doctors, and facilities in **English**, **Hindi**, or **Hinglish**.  
I will reply in the same language you use!
""")
...
@st.cache_resource
def load_docs():
    return WebBaseLoader("https://ncjims.org/departments.html").load()
...
def detect_language(text: str) -> str:
    ...
    hinglish_words = {"hai","hain","nahi","kya","kaise","kahan","mein","main","aur","par","pe","ko","ka","ke","ki","rha","raha","se","me","aap","tum","hum","woh","yeh"}
    words = set(re.findall(r'\b\w+\b', text.lower()))
    hinglish_count = len(words.intersection(hinglish_words))
